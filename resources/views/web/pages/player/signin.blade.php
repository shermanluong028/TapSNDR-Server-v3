...
>
                ...
                <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                    <form class="form w-100 {{ $pageId }}-form">
                        ...
                        <div class="text-center mb-10">
                            <h1 class="text-gray-900 mb-3">Sign In to TapSNDR</h1>
                            <div class="text-gray-500 fw-semibold fs-4">
                                New Here? You can sign in with your
                                ...
                                account or
                                <a
                                    href="{{ url('/auth/signup?redirect_to=' . urlencode(request()->input('redirect_to'))) }}"
    ...
    <script
        type="text/javascript"
        src="{{ URL::asset('assets/web/js/pages/player/signin.js') }}"
    ></script>
    <script
        type="text/javascript"
