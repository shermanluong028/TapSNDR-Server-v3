@php
    $pageId = 'tapsndr-user_activities';
@endphp
...
@push('styles')
    <link
        href="{{ URL::asset('assets/web/css/pages/master_admin/user_activities.css') }}"
        rel="stylesheet"
        type="text/css"
    />
    <link
    ...
    >
        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                <h1 class="text-gray-900 fw-bold my-1 fs-2">User Activities</h1>
            </div>
        </div>
    </div>
...
@push('scripts')
    ...
    <script
        type="text/javascript"
        src="{{ URL::asset('assets/web/js/pages/master_admin/user_activities.js') }}"
    ></script>
@endpush
